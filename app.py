...
BANK_ACCOUNT_NAME = os.environ.get("BANK_ACCOUNT_NAME", "DEMO ACCOUNT NAME")
BANK_ACCOUNT_NUMBER = os.environ.get("BANK_ACCOUNT_NUMBER", "DEMO ACCOUNT NUMBER")

OFFICIAL_TELEGRAM_URL = os.environ.get(
    "OFFICIAL_TELEGRAM_URL", "https://t.me/NexaOfficial_1"
)
CUSTOMER_SERVICE_URL = os.environ.get(
    "CUSTOMER_SERVICE_URL", "https://t.me/NexaSupport11"
)
...
PLANS = [
    {"id": "A", "name": "Plan A", "price": 500,
     "tasks": [("Task 1", 25), ("Task 2", 25), ("Task 3", 25), ("Task 4", 25)]},
    {"id": "B", "name": "Plan B", "price": 1000,
     "tasks": [("Task 1", 50), ("Task 2", 50), ("Task 3", 50), ("Task 4", 50)]},
    {"id": "C", "name": "Plan C", "price": 2000,
     "tasks": [("Task 1", 100), ("Task 2", 100), ("Task 3", 100), ("Task 4", 100)]},
    {"id": "D", "name": "Plan D", "price": 5000,
     "tasks": [("Task 1", 250), ("Task 2", 250), ("Task 3", 250), ("Task 4", 250)]},
    {"id": "E", "name": "Plan E", "price": 10000,
     "tasks": [("Task 1", 500), ("Task 2", 500), ("Task 3", 500), ("Task 4", 500)]},
    {"id": "F", "name": "Plan F", "price": 20000,
     "tasks": [("Task 1", 1000), ("Task 2", 1000), ("Task 3", 1000), ("Task 4", 1000)]},
]
...
<div class="wrap">
<div class="notice"><b>DEMO ONLY:</b> This version simulates balances, task credits, deposits and withdrawals. It does not move real money.</div>
...
def home():
    ...
    <div class="grid">
      <a class="card" style="text-decoration:none;color:inherit" href="/plans">
        <h2>📦 Plans</h2><p>View Plan A, B, C, D, E and F.</p>
      </a>
      ...
      <a class="card" style="text-decoration:none;color:inherit" href="/support">
        <h2>🎧 Customer Service</h2><p>Contact Customer Service: @NexaSupport11</p>
      </a>
...
def deposit():
    ...
    if request.method == "POST":
        ...
        note = f"{note} | Demo fee 10%: {fee:.2f} ETB | Demo net payout: {net_payout:.2f} ETB".strip(" |")
...
def withdraw():
    ...
    <div class="card">
      ...
      <div class="notice">
        ...
        Demo withdrawal fee: 10%<br>
        Example: 1,000 ETB request → 100 ETB demo fee → 900 ETB demo payout<br>
...
def approve_withdrawal(withdrawal_id):
    ...
    flash(
        "Withdrawal approved. This is DEMO ONLY; no real bank transfer is performed.",
        "success"
    )
    return redirect(url_for("admin"))
